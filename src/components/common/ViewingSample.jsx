        ...
        return (
            <Spin spinning={loading}>
                <div style={{margin: '20px'}}>
                    <span>看样时间：</span>
                    <Select allowClear={true} onChange={this.viewTimeChange.bind(this)} placeholder="请选择看样时间" style={{width: '30%',marginLeft: '10px',marginRight: '15%',marginBottom: '30px'}} value={cur_viewTime ? cur_viewTime:undefined}>
                        {
